...
- Contacts live in one config constant, `lib/site.ts`. Real: the office address (334, Office No. 2A, 2nd Floor, Trade Center, Station Road, Kolhapur 416001), timings (Monday to Sunday, 10 am to 7 pm; owner corrected from 8 pm on 2026-08-15), phone +91 93246 01955 and email holidays@inrealife.in (owner-confirmed 2026-08-15). Owner confirmed one number for phone and WhatsApp for now. Still PLACEHOLDER: Instagram/Facebook/YouTube links.
